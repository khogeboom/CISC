...
int main()
{
	...
	do
	{
		...
		cout << "Your weekly food bill over the chosen month is $"
            ...
            // without this loop the user can enter whatever letter or word
            // they want and the program will end unless it is 'Y' or 'y' so this
            // loop makes sure the user enters 'Y' or 'N'
